...
IncludePath            :=  $(IncludeSwitch). $(IncludeSwitch). $(IncludeSwitch)/home/sergiobritto/Matplotlibcpp $(IncludeSwitch)/usr/include/python3.8 $(IncludeSwitch)/home/sergiobritto/.local/lib/python3.8/ 
IncludePCH             := 
RcIncludePath          := 
Libs                   := 
ArLibs                 :=  
